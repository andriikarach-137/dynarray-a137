...
// Function which sets an element at specified index into array list, and returns a status code 
extern arrlst_status arrlst_set(arrlst *arrlst, uint32_t index, AL_ELEMENT elem);
